...
<div class="row justify-content-center my-5">
    <div class="col-lg-6">
        <div class="card shadow border-0 rounded-4 p-4">
            <h1 class="h3 fw-bold text-center text-primary mb-4">Crear Nueva Estación</h1>
            <form action="{{ route('stations.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <select name="type" id="type" class="form-select form-select-lg">
                        <option value="playlist">Playlist por horas</option>
                        <option value="continuous">Música continua</option>
                    </select>
                </div>
